...
export class AppMenuitemComponent implements OnInit, OnDestroy {
    ...
    constructor(public admin: AdminComponent, public router: Router, private cd: ChangeDetectorRef, private menuService: MenuService) {
    ...
    itemClick(event: Event) {
        ...
        if (this.item.items) {
            ...
            // hide overlay menus
            this.admin.menuActiveMobile = false;

            if (this.admin.isDesktop() && this.admin.isOverlay()) {
                this.admin.menuInactiveDesktop = true;
            }
        }
    }
